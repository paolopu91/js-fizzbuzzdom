...
<!-- MILESTONE 1 passaggi:
-creare un ciclo 
-creare un if per i multipli di 3
-creare un else per i multipli di 5
-creare un else if per i multipli di 3&&5
-Il tutto deve essere stampato dentro la console.log
 -->